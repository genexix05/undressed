        ...
        >
          <div className="md:col-span-3">
            ...
            >
              ...
              <p className="font-custom bg-gradient-to-tr from-purple-500 to-pink-500 text-transparent bg-clip-text">
                Undressed
              </p>
            </a>
          </div>
            ...
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
              <div className="relative w-full md:w-1/2">
                <input
                  type="text"
                  placeholder="Buscar..."
                  className="w-full py-2 px-4 border border-gray-300 rounded-full focus:outline-none focus:border-gray-400"
                />
              </div>
            </div>
          </div>
