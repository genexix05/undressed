...
<head>
    ...
    <script>
    var images = {
        negro: "https://5aldia.cl/wp-content/uploads/2018/03/mora.jpg",
        rojo: "https://www.frutas-hortalizas.com/img/fruites_verdures/presentacio/29.jpg",
        gris: "https://theoriginalgarden.com/Argazkiak/Fotos/20200521080904.jpg"
    };
    ...
    function updateProduct() {
        ...
        // Actualizar el precio según la calidad seleccionada
        var precioBase = 1000; // Precio base de los cascos

        if (calidad == 1) {
            precioBase -= precioBase * 0.15; // Calidad baja
        } else if (calidad == 3) {
            precioBase += precioBase * 0.25; // Calidad alta
        }
...
<body>
    <table>
        <tr>
            <td>
                <h1>Mora</h1>
                <p></p>
                <img id="product-image" src="https://5aldia.cl/wp-content/uploads/2018/03/mora.jpg" alt="">
                <p id="product-price">Precio: 2€</p>
            </td>
            <td>
                <br><br><br><br>
                <form action="carrito.php" method="get" oninput="updateProduct()">
                    ...
                    <div class="color-selector">
                        Color:
                        <label><input type="radio" name="color" value="negro" data-image="negro">Morada</label>
                        <label><input type="radio" name="color" value="rojo" data-image="rojo">Roja</label>
                    ...
                    <input type="hidden" value="Mora" name="producto">
                    <input type="hidden" value="1000" name="precio" id="precioBase">
                    <input type="hidden" value="https://5aldia.cl/wp-content/uploads/2018/03/mora.jpg" name="imagen">
                </form>
                <br>
    ...
    function validateStock() {
        // Obtener el color y la cantidad seleccionados
        var color = document.querySelector('input[name="color"]:checked').value;
    ...
    {
        // Reconstruir el vector del stock
        $_SESSION['stock'] = [
            "rojo" => 3,
            "negro" => 3,
            "azul" => 3
    ...
    if (isset($_REQUEST['cantidad']) && isset($_REQUEST['color'])) {
        ...
        // Verificar si se llegó a la página del carrito desde un enlace
